...
public class TicketPriceCalculatorTest {
	...
	void whenCalculatePrice_thenReturnsCorrectAmount(int noOfInfantBookings, int noOfChildBookings,
			int noOfAdultBookings, int expectedTotal) {
		int totalTicketsPrice = ticketPriceCalculator.calculateTotalPriceForTickets(noOfInfantBookings,
